# Documentation: https://catalog.us-east-1.prod.workshops.aws/workshops/3d705026-9edc-40e8-b353-bdabb116c89c/en-US/loops/lab-6/step-3
# Can't get this code to work (need to pass in text, source-language-code, and target-language-code)
