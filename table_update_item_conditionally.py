...
# Update a table item conditionally
# Use UpdateItem method with a condition
# If the condition evaluates to True, the update succeeds
...
dynamodb = boto3.resource('dynamodb', region_name='us-east-2') # Change region to the region your table is in
